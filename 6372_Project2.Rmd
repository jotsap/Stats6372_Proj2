...
main.glm <- glm(diag_bool ~ . , data=bc.boolean, family = binomial(link = "logit"))
summary(main.glm)
...
redux.glm <- glm(diag_bool ~ texture_mean + area_mean + smoothness_mean + compactness_mean + concavity_mean + concave_points_mean + symmetry_mean + fractal_dimension_mean , data=bc.boolean, family = binomial(link = "logit") )
summary(redux.glm)
